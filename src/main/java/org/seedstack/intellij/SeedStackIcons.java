...
public class SeedStackIcons {
    ...
    public static final Icon TOOL = IconLoader.getIcon("/icons/tool.png");

    public static final Icon CONFIG = IconLoader.getIcon("/icons/config.png");
    public static final Icon CONFIG_FILE = IconLoader.getIcon("/icons/configFile.png");
    ...
    public static final Icon AGGREGATE_ROOT = IconLoader.getIcon("/icons/aggregateRoot.png");
